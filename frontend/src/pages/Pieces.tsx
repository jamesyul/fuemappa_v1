                        ...
                        {filteredPieces.length === 0 ? (
                            ...
                            filteredPieces.map((piece: Piece) => (
                                <tr key={piece.id} className="border-t border-gray-200 hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4 text-sm text-gray-700">{piece.quantity ?? 0}</td>
                                    <td className="py-3 px-4 text-sm text-gray-700">€{(piece.price ?? 0).toLocaleString()}</td>
